...
public class ListReportsTextResponseTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        List<ListReportsTextResponseReport> expectedReports =
        [
            new()
            {
                ReportID = "rep_1234567890abcdef1234567890abcdef",
...
public class ListReportsTextResponseReportTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ListReportsTextResponseReport
        {
            ReportID = "rep_1234567890abcdef1234567890abcdef",
            SnapshotMetadata = new()
            {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ListReportsTextResponseReport>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        ListReportsTextResponseReport copied = new(model);
