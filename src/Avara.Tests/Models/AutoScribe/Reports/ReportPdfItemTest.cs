...
public class ReportPdfItemTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ReportPdfItem
        {
            IsCritical = false,
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ReportPdfItem>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        ReportPdfItem copied = new(model);
