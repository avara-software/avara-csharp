...
public class UserUpdateParamsTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        string expectedLastName = "Johnson-Smith";
        ApiEnum<string, AssignableUserLevel> expectedLevel = AssignableUserLevel.Admin;
    ...
    {
        UserUpdateParams parameters = new() { UserID = "usr_1234567890abcdef1234567890abcdef" };
