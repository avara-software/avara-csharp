...
public class UserListParamsTest : TestBase
{
    ...
    {
        var parameters = new UserListParams { CanCreateReports = true };
    ...
    public void OptionalNullableParamsUnsetAreNotSet_Works()
    {
        ...
        Assert.False(parameters.RawQueryData.ContainsKey("canCreateReports"));
    }
    ...
    public void OptionalNullableParamsSetToNullAreSetToNull_Works()
    {
        ...
        Assert.Null(parameters.CanCreateReports);
        Assert.True(parameters.RawQueryData.ContainsKey("canCreateReports"));
    }
    ...
    public void Url_Works()
    {
        ...
        Assert.Equal(
            new Uri(
                "https://api.avarasoftware.com/v1/autoScribe/users?canCreateReports=true&cursor=eyJvZmZzZXQiOjIwfQ%3d%3d&email=user%40example.com&firstName=John&invitedSource=api&lastName=Doe&level=member&limit=20"
            ),
            url
        );
    }
