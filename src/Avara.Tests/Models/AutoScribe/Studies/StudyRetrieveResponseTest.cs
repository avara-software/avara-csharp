...
public class StudyRetrieveResponseTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        List<StudyRetrieveResponsePriorReport> expectedPriorReports =
        [
            new()
            {
                ReportText = "IMPRESSION: No acute cardiopulmonary process.",
...
public class StudyRetrieveResponsePriorReportTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new StudyRetrieveResponsePriorReport
        {
            ReportText = "IMPRESSION: No acute cardiopulmonary process.",
            ExternalStudyID = "EXT-2024-001",
            Modality = "CT",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<StudyRetrieveResponsePriorReport>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        StudyRetrieveResponsePriorReport copied = new(model);
