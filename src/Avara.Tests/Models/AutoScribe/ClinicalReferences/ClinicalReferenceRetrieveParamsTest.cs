...
public class ClinicalReferenceRetrieveParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new ClinicalReferenceRetrieveParams
        {
    ...
    public void CopyConstructor_Works()
    {
        ...
        ClinicalReferenceRetrieveParams copied = new(parameters);
