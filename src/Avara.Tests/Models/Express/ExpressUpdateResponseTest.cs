...
public class ExpressUpdateResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ExpressUpdateResponse
        {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ExpressUpdateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        ExpressUpdateResponse copied = new(model);
