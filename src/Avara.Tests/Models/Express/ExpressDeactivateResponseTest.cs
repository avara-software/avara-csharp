...
public class ExpressDeactivateResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ExpressDeactivateResponse
        {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ExpressDeactivateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        ExpressDeactivateResponse copied = new(model);
