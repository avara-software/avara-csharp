...
public class ExpressListResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ExpressListResponse
        {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ExpressListResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        ExpressListResponse copied = new(model);
