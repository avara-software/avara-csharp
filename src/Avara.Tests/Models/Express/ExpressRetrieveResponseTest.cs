...
public class ExpressRetrieveResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ExpressRetrieveResponse
        {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ExpressRetrieveResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        ExpressRetrieveResponse copied = new(model);
