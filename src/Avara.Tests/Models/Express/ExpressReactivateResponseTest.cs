...
public class ExpressReactivateResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ExpressReactivateResponse
        {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ExpressReactivateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        ExpressReactivateResponse copied = new(model);
