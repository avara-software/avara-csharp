...
public sealed record class ListReportsTextResponse : JsonModel
{
    ...
    /// </summary>
    public required IReadOnlyList<ListReportsTextResponseReport> Reports
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullStruct<ImmutableArray<ListReportsTextResponseReport>>(
                "reports"
            );
        }
        init
        {
            this._rawData.Set<ImmutableArray<ListReportsTextResponseReport>>(
                "reports",
...
/// </summary>
[JsonConverter(
    typeof(JsonModelConverter<ListReportsTextResponseReport, ListReportsTextResponseReportFromRaw>)
)]
public sealed record class ListReportsTextResponseReport : JsonModel
{
    /// <summary>
    /// Unique report identifier. Format: rep_{32-hex-chars}
    /// </summary>
    ...
    public ListReportsTextResponseReport() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ListReportsTextResponseReport(
        ListReportsTextResponseReport listReportsTextResponseReport
    )
        : base(listReportsTextResponseReport) { }
#pragma warning restore CS8618

    public ListReportsTextResponseReport(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    ListReportsTextResponseReport(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="ListReportsTextResponseReportFromRaw.FromRawUnchecked"/>
    public static ListReportsTextResponseReport FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
...
class ListReportsTextResponseReportFromRaw : IFromRawJson<ListReportsTextResponseReport>
{
    /// <inheritdoc/>
    public ListReportsTextResponseReport FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => ListReportsTextResponseReport.FromRawUnchecked(rawData);
}
