...
/// </summary>
public record class StudyUncancelParams : ParamsBase
{
    ...
    public StudyUncancelParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public StudyUncancelParams(StudyUncancelParams studyUncancelParams)
        : base(studyUncancelParams)
    {
        this._rawBodyData = new(studyUncancelParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static StudyUncancelParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(StudyUncancelParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/v1/autoScribe/studies/uncancel"
        )
        {
