...
/// </summary>
public record class ClinicalReferenceUpdateParams : ParamsBase
{
    ...
    public ClinicalReferenceUpdateParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ClinicalReferenceUpdateParams(
        ClinicalReferenceUpdateParams clinicalReferenceUpdateParams
    )
        : base(clinicalReferenceUpdateParams)
    {
        this.ClinicalReferenceID = clinicalReferenceUpdateParams.ClinicalReferenceID;

        this._rawBodyData = new(clinicalReferenceUpdateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static ClinicalReferenceUpdateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData,
        string clinicalReferenceID
    ...
    public virtual bool Equals(ClinicalReferenceUpdateParams? other)
    {
        if (other == null)
        {
            return false;
