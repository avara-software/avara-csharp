...
/// <summary>
/// Retrieves a single user by their unique user ID. Returns the complete user object
/// with all profile information, permissions, AutoScribe-specific settings, and status.
///
