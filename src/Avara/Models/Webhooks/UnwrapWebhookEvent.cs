...
public record class UnwrapWebhookEvent : ModelBase
{
    ...
    public UnwrapWebhookEvent(ModalityWorklistRequestedEvent value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }
    ...
    public static implicit operator UnwrapWebhookEvent(ModalityWorklistRequestedEvent value) =>
        new(value);
