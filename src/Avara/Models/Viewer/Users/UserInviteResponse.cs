...
/// <summary>
/// Response for inviting a user to Viewer. Level is restricted to admin/member since
/// owners cannot be invited via API.
/// </summary>
...
public sealed record class UserInviteResponse : JsonModel
{
    ...
    public required ApiEnum<string, AssignableUserLevel> Level
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<ApiEnum<string, AssignableUserLevel>>("level");
        }
