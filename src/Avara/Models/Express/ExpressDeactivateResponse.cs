...
/// </summary>
[JsonConverter(
    typeof(JsonModelConverter<ExpressDeactivateResponse, ExpressDeactivateResponseFromRaw>)
)]
public sealed record class ExpressDeactivateResponse : JsonModel
{
    /// <summary>
    ...
    public ExpressDeactivateResponse() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ExpressDeactivateResponse(ExpressDeactivateResponse expressDeactivateResponse)
        : base(expressDeactivateResponse) { }
#pragma warning restore CS8618

    public ExpressDeactivateResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    ExpressDeactivateResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="ExpressDeactivateResponseFromRaw.FromRawUnchecked"/>
    public static ExpressDeactivateResponse FromRawUnchecked(
...
class ExpressDeactivateResponseFromRaw : IFromRawJson<ExpressDeactivateResponse>
{
    /// <inheritdoc/>
    public ExpressDeactivateResponse FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => ExpressDeactivateResponse.FromRawUnchecked(rawData);
}
