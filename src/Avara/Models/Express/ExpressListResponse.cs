...
/// </summary>
[JsonConverter(typeof(JsonModelConverter<ExpressListResponse, ExpressListResponseFromRaw>))]
public sealed record class ExpressListResponse : JsonModel
{
    /// <summary>
    ...
    public ExpressListResponse() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ExpressListResponse(ExpressListResponse expressListResponse)
        : base(expressListResponse) { }
#pragma warning restore CS8618

    public ExpressListResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    ExpressListResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="ExpressListResponseFromRaw.FromRawUnchecked"/>
    public static ExpressListResponse FromRawUnchecked(
...
class ExpressListResponseFromRaw : IFromRawJson<ExpressListResponse>
{
    /// <inheritdoc/>
    public ExpressListResponse FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData) =>
        ExpressListResponse.FromRawUnchecked(rawData);
}
