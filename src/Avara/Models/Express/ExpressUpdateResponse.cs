...
/// </summary>
[JsonConverter(typeof(JsonModelConverter<ExpressUpdateResponse, ExpressUpdateResponseFromRaw>))]
public sealed record class ExpressUpdateResponse : JsonModel
{
    /// <summary>
    ...
    public ExpressUpdateResponse() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ExpressUpdateResponse(ExpressUpdateResponse expressUpdateResponse)
        : base(expressUpdateResponse) { }
#pragma warning restore CS8618

    public ExpressUpdateResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    ExpressUpdateResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="ExpressUpdateResponseFromRaw.FromRawUnchecked"/>
    public static ExpressUpdateResponse FromRawUnchecked(
...
class ExpressUpdateResponseFromRaw : IFromRawJson<ExpressUpdateResponse>
{
    /// <inheritdoc/>
    public ExpressUpdateResponse FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => ExpressUpdateResponse.FromRawUnchecked(rawData);
}
