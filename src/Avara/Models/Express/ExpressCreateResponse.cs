...
/// </summary>
[JsonConverter(typeof(JsonModelConverter<ExpressCreateResponse, ExpressCreateResponseFromRaw>))]
public sealed record class ExpressCreateResponse : JsonModel
{
    /// <summary>
    ...
    public ExpressCreateResponse() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ExpressCreateResponse(ExpressCreateResponse expressCreateResponse)
        : base(expressCreateResponse) { }
#pragma warning restore CS8618

    public ExpressCreateResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    ExpressCreateResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="ExpressCreateResponseFromRaw.FromRawUnchecked"/>
    public static ExpressCreateResponse FromRawUnchecked(
...
class ExpressCreateResponseFromRaw : IFromRawJson<ExpressCreateResponse>
{
    /// <inheritdoc/>
    public ExpressCreateResponse FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => ExpressCreateResponse.FromRawUnchecked(rawData);
}
