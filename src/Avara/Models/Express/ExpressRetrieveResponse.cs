...
/// </summary>
[JsonConverter(typeof(JsonModelConverter<ExpressRetrieveResponse, ExpressRetrieveResponseFromRaw>))]
public sealed record class ExpressRetrieveResponse : JsonModel
{
    /// <summary>
    ...
    public ExpressRetrieveResponse() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ExpressRetrieveResponse(ExpressRetrieveResponse expressRetrieveResponse)
        : base(expressRetrieveResponse) { }
#pragma warning restore CS8618

    public ExpressRetrieveResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    ExpressRetrieveResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="ExpressRetrieveResponseFromRaw.FromRawUnchecked"/>
    public static ExpressRetrieveResponse FromRawUnchecked(
...
class ExpressRetrieveResponseFromRaw : IFromRawJson<ExpressRetrieveResponse>
{
    /// <inheritdoc/>
    public ExpressRetrieveResponse FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => ExpressRetrieveResponse.FromRawUnchecked(rawData);
}
