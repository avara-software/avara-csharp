...
public interface IReportService
{
    ...
    /// Must provide either study ID or DICOM Study Instance UID. Returns report metadata
    /// including status, version, and timestamps.
    /// </summary>
    ...
    /// <summary>
    /// Initiates the creation of an addendum to an existing completed report. The
    /// study status will change to 'addendum_active' allowing the radiologist to
    /// dictate additional findings.
    /// </summary>
    ...
    /// The original report remains unchanged. Only valid for active addendums.
    /// </summary>
    ...
    /// <summary>
    /// Retrieves the text content of a report. Can fetch a single report by report
    /// ID, or all reports for a study by study ID/DICOM UID. Returns plain text
    /// report content.
    /// </summary>
...
public interface IReportServiceWithRawResponse
{
    ...
    /// <summary>
    /// Returns a raw HTTP response for `get /v1/autoScribe/reports`, but is otherwise the
    ...
    /// <summary>
    /// Returns a raw HTTP response for `post /v1/autoScribe/reports/{reportId}/addendum`, but is otherwise the
    ...
    /// <summary>
    /// Returns a raw HTTP response for `post /v1/autoScribe/reports/{reportId}/cancel-addendum`, but is otherwise the
