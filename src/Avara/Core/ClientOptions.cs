...
public record struct ClientOptions()
{
    ...
    Lazy<string> _baseUrl = new(() =>
        Environment.GetEnvironmentVariable("AVARA_BASE_URL") ?? EnvironmentUrl.Production
    );
    ...
    /// <see cref="IAvaraClient.WithRawResponse"/>, don't perform validation until deserialization
    /// is triggered.</para>
    /// </summary>
    ...
    Lazy<string> _apiKey = new(() =>
        Environment.GetEnvironmentVariable("AVARA_API_KEY")
